...
class LivePaperAutonomyFunnelSerializer(serializers.Serializer):
    ...
    active_exposure_risk_throttle_summary = serializers.DictField(required=False)
    active_exposure_risk_throttle_examples = serializers.ListField(child=serializers.DictField(), required=False)
    risk_execution_scope_alignment_summary = serializers.DictField(required=False)
    risk_execution_scope_alignment_examples = serializers.ListField(child=serializers.DictField(), required=False)
...
class TestConsoleStatusSerializer(serializers.Serializer):
    ...
    raw_phase = serializers.CharField(required=False, allow_blank=True, allow_null=True)
    current_subphase = serializers.CharField(required=False, allow_blank=True, allow_null=True)
    subphase = serializers.CharField(required=False, allow_blank=True, allow_null=True)
    lifecycle_timeline_summary = serializers.DictField(required=False)
    timeout_source = serializers.DictField(required=False)
    persistent_log_path = serializers.CharField(required=False, allow_blank=True)
    ...
    phase_timings = serializers.DictField(required=False)
    phase_budget_summary = serializers.DictField(required=False)
    diagnostic_example_pagination = serializers.DictField(required=False)
    diagnostic_workload_summary = serializers.DictField(required=False)
    ...
    seconds_since_last_progress = serializers.IntegerField(required=False, allow_null=True)
    last_event = serializers.CharField(required=False, allow_blank=True)
    last_backend_event = serializers.CharField(required=False, allow_blank=True)
    next_expected_event = serializers.CharField(required=False, allow_blank=True)
    ...
    terminal_reason = serializers.CharField(required=False, allow_blank=True)
    lifecycle_warning = serializers.CharField(required=False, allow_blank=True)
    interrupted_by_stop = serializers.BooleanField(required=False)
    interrupted_by_reload = serializers.BooleanField(required=False)
    interrupted_by_server_restart = serializers.BooleanField(required=False)
