...
urlpatterns = [
    ...
    path('run-live-paper-smoke-test', views.RunLivePaperSmokeTestView.as_view()),
    path('live-paper-smoke-test-status/', views.LivePaperSmokeTestStatusView.as_view(), name='live-paper-smoke-test-status'),
    path('live-paper-smoke-test-status', views.LivePaperSmokeTestStatusView.as_view()),
    path('run-live-paper-trial/', views.RunLivePaperTrialRunView.as_view(), name='run-live-paper-trial'),
    path('run-live-paper-trial', views.RunLivePaperTrialRunView.as_view()),
    path('live-paper-trial-status/', views.LivePaperTrialRunStatusView.as_view(), name='live-paper-trial-status'),
    path('live-paper-trial-status', views.LivePaperTrialRunStatusView.as_view()),
    ...
    path('start-extended-paper-run', views.StartExtendedPaperRunView.as_view()),
    path('extended-paper-run-status/', views.ExtendedPaperRunStatusView.as_view(), name='extended-paper-run-status'),
    path('extended-paper-run-status', views.ExtendedPaperRunStatusView.as_view()),
    path('test-console/start/', views.StartTestConsoleView.as_view(), name='test-console-start'),
    path('test-console/stop/', views.StopTestConsoleView.as_view(), name='test-console-stop'),
    path('test-console/status/', views.TestConsoleStatusView.as_view(), name='test-console-status'),
    path('test-console/export-log/', views.TestConsoleExportLogView.as_view(), name='test-console-export-log'),
