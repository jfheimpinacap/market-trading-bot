...
from apps.prediction_agent.views import (
    ...
    PredictionIntakeRunListView,
    PredictionIntakeCandidateListView,
    PredictionConvictionReviewListView,
    PredictionRiskHandoffListView,
    PredictionIntakeRecommendationListView,
    PredictionIntakeSummaryView,
...
urlpatterns = [
    ...
    path('run-intake-review/', PredictionRunIntakeReviewView.as_view(), name='run-intake-review'),
    path('intake-runs/', PredictionIntakeRunListView.as_view(), name='intake-runs'),
    path('intake-candidates/', PredictionIntakeCandidateListView.as_view(), name='intake-candidates'),
    path('conviction-reviews/', PredictionConvictionReviewListView.as_view(), name='conviction-reviews'),
    path('risk-handoffs/', PredictionRiskHandoffListView.as_view(), name='risk-handoffs'),
    path('intake-recommendations/', PredictionIntakeRecommendationListView.as_view(), name='intake-recommendations'),
    path('intake-summary/', PredictionIntakeSummaryView.as_view(), name='intake-summary'),
