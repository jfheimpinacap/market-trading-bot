...
from apps.runtime_governor.views import (
    ...
    RuntimeTuningReviewStateListView,
    RuntimeTuningReviewStateDetailView,
    RuntimeTuningReviewActionListView,
    RuntimeTuningReviewActivityListView,
    RuntimeTuningReviewActivityDetailView,
    RuntimeTuningAutotriageListView,
    RuntimeTuningAutotriageDetailView,
    RuntimeTuningAutotriageAlertSyncView,
    RuntimeTuningAutotriageAlertStatusView,
    RuntimeAcknowledgeTuningScopeView,
    RuntimeMarkTuningScopeFollowupView,
    RuntimeClearTuningScopeReviewView,
    ...
    RuntimeTuningReviewAgingListView,
    RuntimeTuningReviewAgingDetailView,
    RuntimeTuningReviewEscalationListView,
    RuntimeTuningReviewEscalationDetailView,
...
urlpatterns = [
    ...
    path('tuning-review-state/', RuntimeTuningReviewStateListView.as_view(), name='tuning_review_state_list'),
    path('tuning-review-state/<str:source_scope>/', RuntimeTuningReviewStateDetailView.as_view(), name='tuning_review_state_detail'),
    path('acknowledge-tuning-scope/<str:source_scope>/', RuntimeAcknowledgeTuningScopeView.as_view(), name='acknowledge_tuning_scope'),
    path('mark-tuning-scope-followup/<str:source_scope>/', RuntimeMarkTuningScopeFollowupView.as_view(), name='mark_tuning_scope_followup'),
    path('clear-tuning-scope-review/<str:source_scope>/', RuntimeClearTuningScopeReviewView.as_view(), name='clear_tuning_scope_review'),
    path('tuning-review-actions/', RuntimeTuningReviewActionListView.as_view(), name='tuning_review_actions'),
    path('tuning-review-activity/', RuntimeTuningReviewActivityListView.as_view(), name='tuning_review_activity'),
    path('tuning-review-activity/<str:source_scope>/', RuntimeTuningReviewActivityDetailView.as_view(), name='tuning_review_activity_detail'),
    path('tuning-autotriage/', RuntimeTuningAutotriageListView.as_view(), name='tuning_autotriage'),
    path('tuning-autotriage/<str:source_scope>/', RuntimeTuningAutotriageDetailView.as_view(), name='tuning_autotriage_detail'),
    path('sync-tuning-autotriage-alert/', RuntimeTuningAutotriageAlertSyncView.as_view(), name='sync_tuning_autotriage_alert'),
    path('tuning-autotriage-alert-status/', RuntimeTuningAutotriageAlertStatusView.as_view(), name='tuning_autotriage_alert_status'),
    ...
    path('tuning-review-aging/', RuntimeTuningReviewAgingListView.as_view(), name='tuning_review_aging'),
    path('tuning-review-aging/<str:source_scope>/', RuntimeTuningReviewAgingDetailView.as_view(), name='tuning_review_aging_detail'),
    path('tuning-review-escalation/', RuntimeTuningReviewEscalationListView.as_view(), name='tuning_review_escalation'),
    path('tuning-review-escalation/<str:source_scope>/', RuntimeTuningReviewEscalationDetailView.as_view(), name='tuning_review_escalation_detail'),
