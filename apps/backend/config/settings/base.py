...
OLLAMA_ENABLED = get_bool('OLLAMA_ENABLED', default=LLM_ENABLED)
LLM_PROVIDER = get_env('LLM_PROVIDER', 'ollama')
OLLAMA_BASE_URL = get_env('OLLAMA_BASE_URL', 'http://localhost:11434')
OLLAMA_MODEL = get_env('OLLAMA_MODEL', get_env('OLLAMA_CHAT_MODEL', 'llama3.2:3b'))
...
OLLAMA_AUX_SIGNAL_ENABLED = get_bool('OLLAMA_AUX_SIGNAL_ENABLED', default=False)
