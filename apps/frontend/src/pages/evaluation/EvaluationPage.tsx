  ...
  return (
    <div className="page-stack">
      <PageHeader
        ...
        actions={<div style={{ display: 'flex', gap: '0.75rem' }}><button type="button" className="secondary-button" onClick={() => navigate('/continuous-demo')}>Open Continuous Demo</button><button type="button" className="secondary-button" onClick={() => navigate('/learning')}>Open Learning</button></div>}
      />
