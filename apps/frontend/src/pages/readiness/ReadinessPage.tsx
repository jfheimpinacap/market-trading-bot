  ...
  return (
    <div className="page-stack">
      <PageHeader
        ...
        actions={<div className="button-row"><button type="button" className="secondary-button" onClick={() => navigate('/evaluation')}>Open Evaluation</button><button type="button" className="secondary-button" onClick={() => navigate('/experiments')}>Open Experiments</button><button type="button" className="secondary-button" onClick={() => navigate('/runtime')}>Open Runtime</button><button type="button" className="secondary-button" disabled={isSeeding} onClick={() => void onSeedProfiles()}>{isSeeding ? 'Seeding…' : 'Seed base profiles'}</button><button type="button" className="secondary-button" onClick={() => navigate('/certification')}>Open Certification</button></div>}
      />
